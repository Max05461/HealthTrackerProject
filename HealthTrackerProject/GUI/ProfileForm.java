...
import HealthTrackerProject.Model.UserProfile;     // ดึงคลาส UserProfile จาก Model
import HealthTrackerProject.Service.DataManager;   // ดึงคลาส DataManager สำหรับโหลด/บันทึกข้อมูล
