package Service; //ระบุว่าไฟล์นี้อยู่ในแพ็กเกจ Service ซึ่งทำหน้าที่ประมวลผล เช่น คำนวณสุขภาพ

import Model.UserProfile; //นำเข้าคลาส UserProfile สำหรับใช้ดึงข้อมูลผู้ใช้
