package Service; //ระบุว่าไฟล์นี้อยู่ในแพ็กเกจ Service (บริการเบื้องหลัง เช่น จัดการข้อมูล)

import java.io.*; //นำเข้าคลาสที่เกี่ยวข้องกับการอ่านและเขียนไฟล์ เช่น FileInputStream, ObjectInputStream, IOException

import Model.UserProfile; //นำเข้า UserProfile ที่เป็นข้อมูลผู้ใช้ที่เราจะบันทึกหรือโหลด
